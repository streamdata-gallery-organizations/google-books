...
- name: Google Books API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-books/master/_listings/google-books/volumes-volumeid-layersummary-summaryid-get.md
x-common:
- type: x-blog
